    ...
    public static void main(String argv[])
    {
        ...
        try
        {
            ...
            for (String reader: readerPort.keySet())
            {
                ...
                Boolean checkPort = (Boolean)r[i].paramGet(TMConstants.TMR_PARAM_ANTENNA_CHECKPORT);
                String swVersion = (String) r[i].paramGet(TMConstants.TMR_PARAM_VERSION_SOFTWARE);
                if ((model.equalsIgnoreCase("M6e Micro") || model.equalsIgnoreCase("M6e Nano") ||
                    (model.equalsIgnoreCase("Sargas") && (swVersion.startsWith("5.1")))) && (false == checkPort) && readerPort.get(reader) == null)
                {
